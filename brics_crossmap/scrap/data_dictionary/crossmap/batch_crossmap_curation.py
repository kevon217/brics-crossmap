...
def run_hybrid_ss_batch(cfg, **kwargs):
    ...
    crossmap_logger.info("FINISHED Pinecone Semantic Search batch query pipeline!!!")

    # SAVE CONFIG AND MOVE LOG FILE
    helper.save_config(cfg, dir_step1, "config_query.yaml")
    # copy_log(crossmap_logger, dir_step1, "crossmap_logger.log")
